        ...
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              color:
                  isActive
                      ...
                      : Colors.transparent,
              // Light primary color background when active
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  // Space between order indicator and main icon/text
                  Icon(
                    icon,
                  ...
                  // Space between main icon and text
                  Expanded(
                    child: Text(
                      title,
                      style: TextStyle(
                        ...
                        color:
                            isActive
                                ? kTitleTextColor
                                : kGrayColor, // Text color changes based on active state
                      ),
