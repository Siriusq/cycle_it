    ...
    return KeyboardListener(
      ...
      onKeyEvent: (KeyEvent event) {
        if (event is KeyDownEvent &&
          ...
          controller.saveItem(); // Call save on Enter key
        } else if (event is KeyDownEvent &&
            event.logicalKey == LogicalKeyboardKey.escape) {
          Get.back(); // Close dialog on Escape key
        }
      },
      // Ensure focusNode is properly managed. For a simple dialog, this is often sufficient.
      focusNode: FocusNode(),
      child: AlertDialog(
        title: Text(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height:
                      200, // Fixed height for scrollable icon grid
