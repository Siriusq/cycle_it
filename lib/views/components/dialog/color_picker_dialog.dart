...
Future<Color?> showCustomColorPickerDialog(Color initColor) async {
  ...
  return await Get.dialog<Color>(
    // Specify the return type of Get.dialog
    AlertDialog(
        ...
        child: SingleChildScrollView(
          ...
          child: ColorPicker(
            ...
            onColorChanged: (color) {
              // Update local variable immediately for picker to reflect changes
              selectedColor = color;
            },
            width: 44,
            height: 44,
            ...
            title: Text(
              'select_color'.tr,
              style: titleTextStyleLG, // Use Get.context! here
            ),
            subheading: Text(
              'shades_and_tones'.tr,
              style: titleTextStyle, // Use Get.context! here
            ),
